      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden pt-32">
        ...
        <div className="relative z-10 container mx-auto px-4 text-center text-primary-foreground">
          <p className="text-lg md:text-xl lg:text-2xl mb-8 max-w-2xl mx-auto opacity-95 animate-fade-in">
            Transformiramo Vaše prostore sa dekorativnim tehnikama i mikrocementom vrhunske kvalitete
          </p>
      ...
      <section className="py-20 bg-card">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-4">Zašto izabrati Tactura?</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-8 rounded-xl bg-background hover:shadow-xl transition-shadow">
